...
public class Configuracao implements Serializable {
    ...
    @Column
    private String EMP_EMAILRESPOSTACM;//CARTA DE MANUTENÇÃO
...
//    private CondicaoPagamento condPagOrc;
    ...
    @Column(length = 350)
    private String RESPONSAVELCARTAMANUTENCAO;
    ////
    @Transient
    ...
    public void setEMP_EMAILRESPOSTACM(String EMP_EMAILRESPOSTACM) {
        this.EMP_EMAILRESPOSTACM = EMP_EMAILRESPOSTACM;
    }
    ...
    public String getRESPONSAVELCARTAMANUTENCAO() {
        if (RESPONSAVELCARTAMANUTENCAO == null) {
            RESPONSAVELCARTAMANUTENCAO = "";
        }
        return RESPONSAVELCARTAMANUTENCAO;
    }

    public void setRESPONSAVELCARTAMANUTENCAO(String RESPONSAVELCARTAMANUTENCAO) {
        this.RESPONSAVELCARTAMANUTENCAO = RESPONSAVELCARTAMANUTENCAO;
    }
