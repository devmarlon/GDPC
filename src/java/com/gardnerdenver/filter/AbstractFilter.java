...
public class AbstractFilter {
    ...
    protected void doNotFound(ServletRequest request, ServletResponse response, HttpServletRequest req) throws ServletException, IOException {
        RequestDispatcher rd = req.getRequestDispatcher("/pages/protected/pagenotfound.xhtml");
        rd.forward(request, response);
    }
